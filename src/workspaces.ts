...
import { WorkspaceSchema } from '@waylaidwanderer/sumika-types';

import logger from './logger';

import type { McpServer, Workspace } from '@waylaidwanderer/sumika-types';
...
export class WorkspaceManager {
    ...
    constructor(baseDir?: string) {
        ...
        this.SUMIKA_DIR = join(home, '.sumika');
        this.WORKSPACES_DIR = join(this.SUMIKA_DIR, 'workspaces');
        this.SESSIONS_DIR = join(this.SUMIKA_DIR, 'sessions');
        this.WORKSPACES_METADATA_FILE = join(this.SUMIKA_DIR, 'workspaces.json');
    }
    ...
    public async createWorkspace(name: string, description?: string, customPath?: string): Promise<Workspace> {
        ...
        if (customPath) {
            ...
            workspacePath = join(this.WORKSPACES_DIR, id);
    ...
    public async deleteWorkspace(id: string, deleteFiles: boolean): Promise<boolean> {
        ...
        const sessionDir = join(this.SESSIONS_DIR, id);
